...
var solmap_common = require('sol_map_field.solmap_common');
...
var MapFormWidget = AbstractField.extend(solmap_common.SolMapMixin,{
    ...
    start: function() {
        ...
        if (self.mode==='edit' && !this.get('effective_readonly')){
            if (this.nodeOptions.geo_draw_btn){
                if(parseInt(this.nodeOptions.geo_draw_btn) ===1){
    ...
    _renderDraggableMarker : function(){
        ...
        setTimeout(function(){
            ...
            if (self.mode==='edit'){
                if (self.nodeOptions.geo_drag_mark){
                    if(parseInt(self.nodeOptions.geo_drag_mark) === 1 ){
